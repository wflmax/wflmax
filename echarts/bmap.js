			...
			function(module, exports, __webpack_require__) {
				...
				!(__WEBPACK_AMD_DEFINE_RESULT__ = function(require) {
					...
					function BMapCoordSys(bmap, api) {
						console.log('BMapCoordSys',this,bmap,api);
						this._bmap = bmap;
					...
					BMapCoordSys.create = function(ecModel, api) {
						...
						var root = api.getDom();
						console.log('BMapCoordSyscreate',root,api);
						// TODO Dispose
						ecModel.eachComponent('bmap', function(bmapModel) {
					...
					console.log('BMapCoordSyreturn',BMapCoordSys);
					return BMapCoordSys;
				}.call(exports, __webpack_require__, exports, module), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
				...
				!(__WEBPACK_AMD_DEFINE_RESULT__ = function(require) {
					...
					return __webpack_require__(1).extendComponentView({
						...
						render: function(bMapModel, ecModel, api) {
							console.log('bMapModel',bMapModel,'ecModel',ecModel);
							var rendering = true;
							var bmap = bMapModel.getBMap();
							var viewportRoot = api.getZr().painter.getViewportRoot();
